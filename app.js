...
const GENZ_TRANSLATIONS = [
  ...
  ["The findings matter for five areas: civic and relational education, youth welfare, gender equality, third places and digital platform governance. A response focused only on communication would be too narrow: the divide is also connected to material insecurity, weakening social infrastructure, online identity formation and the difficulty of building caring, non-reactive forms of masculinity.", "I risultati sono rilevanti per cinque ambiti: educazione civica e relazionale, welfare giovanile, parità di genere, spazi sociali e governance delle piattaforme digitali. Una risposta centrata solo sulla comunicazione sarebbe troppo stretta: il divario è collegato anche a insicurezza materiale, indebolimento dell'infrastruttura sociale, formazione identitaria online e difficoltà di costruire forme di maschilità di cura, non reattive."],
  ["These implications are exploratory. The analysis identifies patterns and associations, not the causal effect of specific interventions.", "Queste implicazioni sono esplorative. L'analisi identifica pattern e associazioni, non l'effetto causale di interventi specifici."],
